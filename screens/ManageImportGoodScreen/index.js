...
const ManageImportGoodScreen = ({ navigation }) => {
  ...
  const updateGood = () => {
    fetch(Settings.API_DOMAIN + "import-good/" + updateGoodData.id, {
      method: 'PUT',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
  ...
  return (
    <View style={Styles.screen}>
      ...
      <View style={Styles.container}>
        <Text style={Styles.title}>Quản lý hàng nhập</Text>
...
export default ManageImportGoodScreen